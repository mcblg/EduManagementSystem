        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">录入学校部门信息</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
...
<section class="content">
    <div class="row">
                ...
                <div class="card-body">
                    <table id="universityTable" class="table table-striped">
                        ...
                        <tr>
                            ...
                            <th>创建人</th>
                            <th>创建时间</th>
                            <@shiro.hasPermission name ="departmentLockOrUnLock">
                            <th>部门状态</th>
                            </@shiro.hasPermission>
                        </tr>
                        </thead>
        ...
        <div class="col-md-4">
            <@shiro.hasPermission name ="addDepartment">
            <div class="card card-info">
                <div class="card-header">
                    <h3 class="card-title">新增部门信息</h3>
                    <div class="card-tools">
                        <button type="button" class="btn btn-tool" data-card-widget="collapse" data-toggle="tooltip"
                                title="Collapse">
...
<script>
    $(document).ready(function () {
        ...
        $("#universityTable").DataTable({
            ...
            "ajax": {
                "url": "${path}/departmentInfoList",
                "dataSrc": function (json) {
                    for (let i = 0; i < json.data.length; i++) {
                        if (json.data[i].status == 0) {
                            json.data[i].status = '<@shiro.hasPermission name ="departmentLockOrUnLock"><div class="btn-group btn-group-toggle" data-toggle="buttons">\n' +
