...
<section class="content">
                ...
                <div class="card-body">
                    <table id="universityAreaTable" class="table table-striped">
                        ...
                        <tr>
                            ...
                            <th>创建人</th>
                            <th>创建时间</th>
                            <@shiro.hasPermission name ="fieldLockOrUnLock">
                            <th>场地状态</th>
                            </@shiro.hasPermission>
                        </tr>
                        </thead>
    ...
    <div class="row">
        <@shiro.hasPermission name ="addField">
        <div class="col-md-6">
        ...
        <@shiro.hasPermission name ="editField">
        <div class="col-md-6">
                ...
                "dataSrc": function (json) {
                    for (let i = 0; i < json.data.length; i++) {
                        if (json.data[i].status == 0) {
                            json.data[i].status = '<@shiro.hasPermission name ="fieldLockOrUnLock"><div class="btn-group btn-group-toggle" data-toggle="buttons">\n' +
